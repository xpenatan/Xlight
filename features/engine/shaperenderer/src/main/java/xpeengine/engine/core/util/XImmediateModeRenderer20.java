...
package xpeengine.engine.core.util;
 ...
 * @author mzechner */
public class XImmediateModeRenderer20 implements ImmediateModeRenderer {
	...
	public XImmediateModeRenderer20(boolean hasNormals, boolean hasColors, int numTexCoords) {
		this(5000, hasNormals, hasColors, numTexCoords, createDefaultShader(hasNormals, hasColors, numTexCoords));
		ownsShader = true;
	}

	public XImmediateModeRenderer20(int maxVertices, boolean hasNormals, boolean hasColors, int numTexCoords) {
